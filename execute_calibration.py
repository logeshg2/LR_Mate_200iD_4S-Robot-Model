'''
    ...
    Example calibration data can be viewed in './calib_data/'
'''
...
cam_matrix = load_calib_data("./calib_data/camera_matrix.pkl")
...
def perform_camera_calibration():
    ...
    image_array = collect_checker_board_images(
        camera = cam,
        save_dir = "./calib_data/checkboard_data/"
    )
    ...
    # save calibration
    save_calib_data(cam_mat, "./calib_data/camera_matrix.pkl")
    save_calib_data(dist_cof, "./calib_data/dist_coef.pkl")
...
def perform_hand_eye_calibration():
    ...
    save_calib_data(R_g2b, "./calib_data/hand_eye_data/R_g2b.pkl")
    save_calib_data(R_t2c, "./calib_data/hand_eye_data/R_t2c.pkl")
    save_calib_data(t_g2b, "./calib_data/hand_eye_data/t_g2b.pkl")
    save_calib_data(t_t2c, "./calib_data/hand_eye_data/t_t2c.pkl")
    ...
    save_calib_data(R_b2c, "./calib_data/hand_eye_rotm.pkl")
    save_calib_data(t_b2c, "./calib_data/hand_eye_trans.pkl")
